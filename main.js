...
const _F2F_CATS = new Set(['f2f', 'gigs', 'petsitting', 'babysitting', 'retail', 'clinical', 'mystery']);
...
const curationFilters = {
  ...
  variable: p => {
    ...
    if(['Merytu','Grabr'].includes(p.name)) return true;
...
function applyLang(){
  ...
  setInner2('canaisTpDesc',        'Vagas de apoio ao cliente em inglês e outras línguas em Lisboa. Alta procura contínua.',
                                   'Customer support vacancies in English and other languages in Lisbon. High ongoing demand.');
  // Calculator
  ...
  // Welcome modal boost prices (PT: "4,99€" / EN: "€4.99")
