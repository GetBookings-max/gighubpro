...
const translations = {
  pt: {
    ...
    monoDesc: 'Envia 14,99€ por transferência bancária e partilha o comprovativo via WhatsApp.',
  ...
  en: {
    ...
    monoDesc: 'Send €14.99 by bank transfer and share the receipt via WhatsApp.',
