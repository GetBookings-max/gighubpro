...
function calcEarnings(){
  ...
  const sPT={2:'Prolific + Toluna + AttaPoll.',6:'Uber Eats ou Glovo.',7:'Outlier AI + DataAnnotation.tech.',8:'Rover + Zoowish + Babysits.pt.',10:'Upwork + Fiverr.',18:'Respondent.io + UserInterviews (disponibilidade limitada em PT).'};
  const sEN={2:'Prolific + Toluna + AttaPoll.',6:'Uber Eats or Glovo.',7:'Outlier AI + DataAnnotation.tech.',8:'Rover + Zoowish + Babysits.',10:'Upwork + Fiverr.',18:'Respondent.io + UserInterviews (limited availability in PT).'};
...
function render(){
  ...
  grid.innerHTML=list.map((p,i)=>{
    ...
    const cardClass = p.top?'top':(p.beginner && p.cat!=='f2f'?'beginner-pick':(p.dimmed?'dimmed':''));
    return `
...
const translations = {
  pt: {
    ...
    sortEasy: '✓ Mais fácil',
    sortName: 'A–Z Nome',
    heroTag: '✅ 115 plataformas verificadas · Atualizado',
    ...
    lockHeadline: '115 plataformas<br><em>verificadas</em> num só lugar',
    ...
    lockIncluiDesc: '115 plataformas<br>Acesso de longa duração',
    ...
    welcomeBody: 'Tens acesso a <strong style="color:var(--ink)">115 plataformas verificadas</strong> para ganhar dinheiro online — surveys, freelance, IA, gigs físicos e muito mais.<br><br>Usa os filtros para encontrar o que funciona para ti. Começa pelas marcadas como <strong style="color:var(--green)">TOP PICK</strong>.',
  ...
  en: {
    ...
    sortName: 'A–Z Name',
    heroTag: '✅ 115 verified platforms · Updated',
    ...
    lockHeadline: '115 verified<br><em>platforms</em> in one place',
    ...
    lockIncluiDesc: '115 platforms<br>Long-term access',
...
function applyLockLang(){
  ...
  setText('lockIncluiDesc', '115 plataformas · Acesso de longa duração', '115 platforms · Long-term access');
  // Step labels
...
const _BLOCKED = new Set(['Hostbreak','Billo','iFood Entregador','Pinecone Research']);
...
const _REDUCED_EXPECTATIONS = {
  'Respondent.io': {
    desc: 'Plataforma de entrevistas UX com remuneração elevada. Acesso muito limitado para utilizadores PT — poucos estudos disponíveis, alta barreira de seleção e maioria dos estudos requer inglês fluente.',
    descEn: 'High-paying UX interview platform. Very limited availability for PT users — few studies available, high selection bar, and most studies require fluent English.'
  },
  'UserInterviews': {
...
function _fmt(r){
  ...
  return {
    ...
    desc: (ov && ov.desc) ? ov.desc : (r.desc_pt||''),
    descEn: (ov && ov.descEn) ? ov.descEn : (r.desc_en||''),
    earn: r.earn||'',
    ...
    top:r.top, dimmed:r.dimmed||false,
