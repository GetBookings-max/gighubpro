  ...
  },
  {
    ...
    subgroups: [
      { labelPt:'🏠 Espaço Físico ou Loja', labelEn:'🏠 Physical space or shop',
        cats:['passive'], filter: p => !['Revolut Affiliate','XTB Partnerships','Booking Affiliate','Amazon Affiliate','Shopify Affiliate','Trade Republic Affiliate','Temu Affiliate','Letyshops','BeRuby'].includes(p.name) },
      ...
      { labelPt:'💳 Cashback (Ganha ao Comprar)', labelEn:'💳 Cashback (Earn when you shop)',
        cats:['passive'], filter: p => ['Letyshops','BeRuby'].includes(p.name) },
