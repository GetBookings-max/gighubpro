...
const _CAT_EARNINGS_FALLBACK = {
  gigs:'variavel', petsitting:'estavel', babysitting:'estavel', f2f:'estavel', micro:'variavel',
...
const _LOCAL_EXTRA_PLATFORMS = [
  ...
  },
  {
    ...
    cat: 'f2f',
    icon: '🏡',
    desc: 'Candidata-te como consultor imobiliário independente na maior rede imobiliária mundial. A RE/MAX Portugal oferece formação, ferramentas digitais e suporte de marca. Regime 100% comissão — sem salário fixo. Requer licença AMI.',
    descEn: 'Apply as an independent real estate consultant at the world\'s largest real estate network. RE/MAX Portugal offers training, digital tools and brand support. 100% commission-based — no fixed salary. AMI licence required.',
    earn: 'Comissão por transação',
    earnN: 9,
    minPay: 'Por venda',
    pt: true, eu: false,
    url: 'https://remax.pt/pt/recrutamento',
    easy: 3, geo: '🇵🇹 Portugal',
    top: false, dimmed: false, beginner: false,
    ratings: {}, aff: { has: false },
    entry_level: 'moderado', earnings_type: 'variavel', tier: 1,
  ...
  },
  {
    ...
    cat: 'f2f',
    icon: '💼',
    desc: 'Programa de recrutamento de agentes de seguros MetLife em Portugal. A MetLife fornece formação gratuita até à obtenção do certificado de agente de seguros — sem custos para o candidato. Após certificação, regime de consultor independente com ferramentas digitais e suporte contínuo. Ganhos 100% por comissão sobre seguros de vida e acidentes pessoais.',
    descEn: 'MetLife insurance agent recruitment programme in Portugal. MetLife provides free training through to obtaining the insurance agent certificate — at no cost to the candidate. After certification, self-employed consultant regime with digital tools and ongoing support. 100% commission-based earnings on life and personal accident insurance.',
