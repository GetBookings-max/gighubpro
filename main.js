...
// ── DATA ──
const catLabels = {
  pt: {surveys:'Surveys',gigs:'Gigs',freelance:'Freelance',micro:'Treino de IA',testing:'Testes',criativo:'Stock & Design',conteudo:'Conteúdo',tasks:'Get-Paid-To',mystery:'Cliente Mistério',transcricao:'Transcrição',tutoring:'Tutoria',ugc:'UGC',passive:'Nicho',remote:'Emprego Remoto',petsitting:'Pet Sitting',babysitting:'Babysitting',f2f:'Trabalho Presencial',clinical:'Ensaios Clínicos'},
  en: {surveys:'Surveys',gigs:'Gigs',freelance:'Freelance',micro:'AI Training',testing:'App Testing',criativo:'Stock & Design',conteudo:'Content',tasks:'Get-Paid-To',mystery:'Mystery Shopping',transcricao:'Transcription',tutoring:'Tutoring',ugc:'UGC',passive:'Niche',remote:'Remote Jobs',petsitting:'Pet Sitting',babysitting:'Babysitting',f2f:'In-Person Work',clinical:'Clinical Trials'}
};
...
function applyLang(){
  ...
  const _TAB_SHORT = {
    pt:{'':'Todas','surveys':'📝 Inquéritos','testing':'🔬 Testes','micro':'🤖 Treino IA',
      ...
      'f2f':'🤝 Trabalho Presencial','clinical':'🩺 Ensaios Clínicos','other':'💚 Outros'},
    en:{'':'All','surveys':'📝 Surveys','testing':'🔬 Testing','micro':'🤖 AI Training',
      ...
      'f2f':'🤝 In-Person Work','clinical':'🩺 Clinical Trials','other':'💚 Other'}
  };
...
const _EARN_N_DEFAULT = {
  ...
  petsitting:9, babysitting:9, gigs:7, f2f:9, mystery:6, clinical:500
};
...
const _ALLOWED_PLATFORMS = new Set([
  ...
  'tgm panel','triaba','voissy',
  'voz do consumidor','yougov',
  'prime opinion','qmee','surveoo','sproutgigs',
  // 🔬 Testes
  ...
  // 🎁 Get-Paid-To
  'earnlab','freecash','lootup','storewards','swagbucks','ysense',
  'beruby',
  // 🚗 Entregas / Condução
