...
const translations = {
  pt: {
    ...
    guideTip: '💡 <strong>Dica —</strong> Muitos utilizadores combinam 3–5 plataformas de diferentes categorias para estabilizar o rendimento ao longo do mês.',
  ...
  en: {
    ...
    guideTip: '💡 <strong>Tip —</strong> Many users combine 3–5 platforms from different categories to stabilise their income throughout the month.',
