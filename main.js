...
const curationFilters = {
  ...
  stable: p => {
    ...
    if(['TaskRabbit','Merytu','Worldpackers','Casamentos.pt','Eloquence Events'].includes(p.name)) return false;
  ...
  variable: p => {
    ...
    if(['Merytu','TaskRabbit','Worldpackers','Casamentos.pt','Eloquence Events'].includes(p.name)) return true;
