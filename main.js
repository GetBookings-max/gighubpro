...
const translations = {
  pt: {
    ...
    heroDesc: 'Surveys pagos, freelance, treino de IA, gigs presenciais, caregiving e muito mais.',
    ...
    welcomeBody: 'Tens acesso a <strong style="color:var(--ink)">+100 plataformas verificadas</strong> para ganhar dinheiro online — surveys, freelance, IA, gigs físicos e muito mais.',
  ...
  en: {
    ...
    heroDesc: 'Surveys, freelance, AI training, physical gigs, caregiving and more.',
    statPt: 'Available PT',
    statCats: 'Categories',
...
const _CAT_OVERRIDES = {
  ...
  // Cinema City / NOS Cinemas → Lojas, Armazéns e Logística (retail_stores tab = f2f cat)
  'Cinema City': 'f2f',
  'NOS Cinemas': 'f2f',
  // Solverde → Turismo e Eventos (gigs)
  'Solverde': 'gigs',
  // Pitagorica → Atendimento & Suporte (support)
  'Pitagorica': 'support',
  // Procme → Segurança, Limpeza e Trabalho Operacional (f2f — aparece no cat security)
  'Procme': 'f2f',
  // EM Estudos de Mercado → Surveys
  'EM Estudos de Mercado': 'surveys',
...
const _ALLOWED_PLATFORMS = new Set([
  ...
  // Adicionados — Cinema City, NOS Cinemas, Solverde, Pitagorica, Procme, EM Estudos de Mercado
  'cinema city recrutamento',
  'pitagorica recrutamento','pitagorica contact center',
  'procme','procme recrutamento',
  'solverde','solverde recrutamento',
  ...
  // 'central de cervejas', — removida a pedido (apagar da DB via SQL script)
  'blue & green hotels',
  'barraqueiro',
  'city sightseeing',
...
const CAT_EXPLORER_DEFS = [
  {
    id: 'deliveries',
    emoji: '🚗',
    titlePt: '🚗 Conduz e Faz Entregas',
    titleEn: '🚗 Drive & Deliver',
    descPt: 'Estafeta, condução, logística — flexível, sem horário fixo.',
    descEn: 'Courier, driving, logistics — flexible, no fixed schedule.',
    color: '#2d7a4f',
    platforms: [
      ...
      { name:'Uber Eats',    desc:'Estafeta Uber Eats', url:'https://www.uber.com/pt/pt-br/deliver/', icon:'🍔' },
  ...
  },
  {
    id: 'retail_stores',
    emoji: '🏪',
    titlePt: '🏪 Trabalha em Lojas, Armazéns e Logística',
    titleEn: '🏪 Work in Stores, Warehouses & Logistics',
    descPt: 'Retalho, armazém, logística e operações — contrato de trabalho, formação incluída.',
    descEn: 'Retail, warehouse, logistics and operations — employment contract, training included.',
    color: '#5a3a0a',
    platforms: [
      { name:'Cinema City',     desc:'Vende bilhetes, atende clientes e assegura as salas — part-time e turnos', url:'https://www.cinemacity.pt/careers', icon:'🎬' },
      { name:'NOS Cinemas',     desc:'Staff de bilheteira, bar e salas — horários flexíveis em todo o país', url:'https://www.noscinemas.pt/recrutamento', icon:'🎥' },
      ...
      { name:'DHL',             desc:'Estafeta e logística DHL', url:'https://www.dhl.com/pt-pt/home/careers.html', icon:'🟡' },
  ...
  },
  {
    id: 'callcenter',
    emoji: '🎧',
    titlePt: '🎧 Trabalha num Call Center',
    titleEn: '🎧 Work in a Call Centre',
    descPt: 'Call centers, apoio ao cliente e backoffice.',
    descEn: 'Call centres, customer support and back office.',
    color: '#0a5a5a',
    platforms: [
      { name:'Teleperformance',   desc:'Maior call center em Portugal', url:'https://jobs.teleperformance.com', icon:'📱' },
      { name:'Pitagorica',        desc:'Contact center e apoio ao cliente', url:'https://www.pitagorica.pt/carreiras', icon:'🎧' },
      ...
      { name:'ComparaJá',         desc:'Consultor de produtos financeiros (contact center híbrido)', url:'https://www.comparaja.pt/careers', icon:'💳' },
      { name:'Consultor Kobold',  desc:'Venda direta de produtos de limpeza (híbrido)', url:'https://www.kobold.vorwerk.pt', icon:'🧹' },
    ]
  },
  {
    id: 'summer',
    emoji: '🌞',
    titlePt: '🌞 Turismo, Verão e Eventos',
    titleEn: '🌞 Tourism, Summer & Events',
    descPt: 'Hotéis, parques temáticos, eventos e experiências — sazonal, ideal junho–setembro.',
    descEn: 'Hotels, theme parks, events and experiences — seasonal, ideal June–September.',
    color: '#e84c3d',
    platforms: [
      { name:'Solverde',          desc:'Dealer, staff de casino e hotelaria do Grupo Solverde', url:'https://www.solverde.pt/recrutamento', icon:'🎰' },
      ...
      { name:'GetYourGuide',      desc:'Afiliados e guias de atividades turísticas', url:'https://partner.getyourguide.com', icon:'🗺️' },
  ...
  },
  {
    id: 'security',
    emoji: '🦺',
    titlePt: '🦺 Segurança, Limpeza e Trabalho Operacional',
    titleEn: '🦺 Security, Cleaning & Operational Work',
    descPt: 'Vigilância, limpeza, manutenção e operações — formação paga pela empresa, contrato de trabalho.',
    descEn: 'Security, cleaning, maintenance and operations — company-paid training, employment contract.',
    color: '#3a3a5a',
    platforms: [
      { name:'Prosegur',            desc:'Segurança privada e transporte de valores', url:'https://www.prosegur.pt/quero-trabalhar-na-prosegur', icon:'🔒' },
      { name:'Procme',              desc:'Recrutamento de armazém, condutor, técnico e operacional', url:'https://www.procme.pt', icon:'🏭' },
      ...
      { name:'Ecoambiente',         desc:'Serviços de limpeza e ambiente urbano', url:'https://www.ecoambiente.pt/recrutamento', icon:'🌿' },
      { name:'Luz Saúde',           desc:'Auxiliar de limpeza e suporte hospitalar (Grupo Luz)', url:'https://www.luzsaude.pt/pt/trabalhar-connosco', icon:'🏥' },
      { name:'Lusíadas Saúde',      desc:'Auxiliar de limpeza, receção e suporte hospitalar', url:'https://www.lusiadassaude.pt/carreiras', icon:'🩺' },
      ...
      { name:'Grupo Nabeiro',       desc:'Staff operacional Delta Cafés e hotelaria', url:'https://www.gruponabeiro.com/pt/recursos-humanos', icon:'☕' },
  ...
  },
  {
    id: 'clinical',
    emoji: '🧪',
    titlePt: '🧪 Participa em Estudos Médicos',
    titleEn: '🧪 Participate in Medical Studies',
    descPt: 'Ensaios clínicos e estudos científicos pagos — por projeto, podem pagar centenas de euros.',
    descEn: 'Paid clinical trials and scientific studies — per project, can pay hundreds of euros.',
    color: '#0a6ba8',
    platforms: [
  ...
  },
  {
    id: 'fundraising',
    emoji: '🤝',
    titlePt: '🤝 Angariação de Assinaturas na Rua',
    titleEn: '🤝 Street Fundraising',
    descPt: 'Trabalha para ONGs a angariar sócios e donativos na rua — salário fixo + bónus, entrada fácil, sem experiência.',
    descEn: 'Work for NGOs raising members and donations on the street — fixed salary + bonus, easy entry, no experience.',
    color: '#1a7a3a',
    platforms: [
      { name:'ACNUR',                desc:'Angariador de donativos ACNUR (F2F)', url:'https://www.acnur.org/pt/angariacao', icon:'🕊️' },
      { name:'APDES',                desc:'Trabalho social e angariação F2F', url:'https://www.apdes.pt', icon:'🤝' },
      { name:'Associação Salvador',  desc:'Angariador de fundos Salvador (F2F)', url:'https://www.associacaosalvador.com', icon:'♿' },
      { name:'Amnistia Internacional', desc:'Angariador de direitos humanos (F2F)', url:'https://www.amnistia.pt/trabalha-connosco/', icon:'🕯️' },
      { name:'WWF Portugal',         desc:'Angariador de fundos WWF (F2F)', url:'https://wwf.pt/o-que-fazemos/trabalha-connosco/', icon:'🐼' },
      { name:'Ponto Verde',          desc:'Sensibilizador ambiental (F2F)', url:'https://www.pontoverde.pt/recrutamento', icon:'♻️' },
    ]
  },
  {
    id: 'gigs_services',
    emoji: '🛠️',
    titlePt: '🛠️ Faz Biscates/Trabalha por Conta Própria',
    titleEn: '🛠️ Do Odd Jobs/Self-Employed Work',
    descPt: 'Tutoria, biscates, animais, babysitting, traduções e serviços locais — trabalha quando quiseres.',
    descEn: 'Tutoring, odd jobs, pet care, babysitting, translation and local services — work when you want.',
    color: '#8228b4',
    platforms: [
  ...
  },
  {
    id: 'surveys',
    emoji: '📱',
    titlePt: '📱 Responde a Inquéritos e Faz Missões Pagas',
    titleEn: '📱 Answer Surveys & Complete Paid Missions',
    descPt: 'Ganha dinheiro a testar produtos, responder a questionários ou visitar lojas.',
    descEn: 'Earn money testing products, answering surveys or visiting stores.',
    color: '#7a3e00',
    platforms: [
      { name:'EM Estudos de Mercado', desc:'Painel de consumidores — inquéritos e estudos de mercado', url:'https://www.em-estudosdemercado.pt/painel-consumidores/', icon:'📊' },
  ...
  },
  {
    id: 'pickup',
    emoji: '🏠',
    titlePt: '🏠 Ganha Dinheiro com o Que Já Tens',
    titleEn: '🏠 Earn Money with What You Already Have',
    descPt: 'Transforma a tua loja ou espaço num ponto de recolha ou ganha com programas de afiliados.',
    descEn: 'Turn your shop or space into a pickup point or earn through affiliate programmes.',
    color: '#0e64b4',
    platforms: [
...
(function _hookCatExplorer() {
  ...
  window.render = function() {
    ...
    // Debounced to prevent thrashing on rapid filter/search changes
    if(hasAccess && document.getElementById('catGrid')) {
      clearTimeout(_catExplorerTimer);
      _catExplorerTimer = setTimeout(() => renderCatExplorer(), 0);
    }
  };
})();
