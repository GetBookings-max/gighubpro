...
const _LOCAL_EXTRA_PLATFORMS = [
  ...
  },
  {
    ...
    cat: 'f2f',
    icon: '🛒',
    desc: 'Empresa portuguesa de distribuição alimentar com recrutamento regular. Vagas em armazém, logística, motoristas e administrativos em diversas regiões do país.',
    descEn: 'Portuguese food distribution company with regular hiring. Warehouse, logistics, driver and administrative roles across the country.',
    earn: 'Salário mensal',
    earnN: 9,
    minPay: 'Mensal',
    pt: true, eu: false,
  ...
  },
  {
    ...
    cat: 'criativo',
    icon: '🎫',
    desc: 'Cria e publica conteúdo sobre destinos e experiências na maior plataforma mundial de tours. Guias, fotógrafos e criadores podem candidatar-se ao programa de criadores.',
    descEn: 'Create and publish destination and experience content on the world's largest tours platform. Guides, photographers and creators can apply to the creator programme.',
