...
const translations = {
  pt: {
    ...
    lockStep1Desc: 'Envia <span style="white-space:nowrap"><span style="font-size:11px;opacity:.4;text-decoration:line-through;margin-right:3px">29,99€</span><strong>24,99€ via MB Way</strong></span> para <strong>938 556 803</strong> e clica no botão. Recebes a tua chave de acesso em minutos.',
  ...
  en: {
    ...
    lockStep1Desc: 'Send <span style="white-space:nowrap"><span style="font-size:11px;opacity:.4;text-decoration:line-through;margin-right:3px">€29.99</span><strong>€24.99 via MB Way</strong></span> to <strong>938 556 803</strong> and click the button. You will receive your access key in minutes.',
...
function applyLockLang(){
  ...
  if(desc1) desc1.innerHTML = isEn
    ? 'Send <span style="white-space:nowrap"><span style="font-size:11px;opacity:.4;text-decoration:line-through;margin-right:3px">€29.99</span><strong>€24.99 via MB Way</strong></span> to <strong>938 556 803</strong> and click the button. You will receive your access key in minutes.'
    : 'Envia <span style="white-space:nowrap"><span style="font-size:11px;opacity:.4;text-decoration:line-through;margin-right:3px">29,99€</span><strong>24,99€ via MB Way</strong></span> para <strong>938 556 803</strong> e clica no botão. Recebes a tua chave de acesso em minutos.';
