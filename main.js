...
function calcEarnings(){
  ...
  const sPT={
    2:'AttaPoll + YouGov + OnePulse. Para ganhos extra junta Freecash ou ySense (Get-Paid-To).',
    6:'Uber Eats (Courier), Glovo ou Bolt Food (Courier) — alta procura nas cidades PT.',
    7:'DataAnnotation.tech + Clickworker. Para perfis qualificados: Outlier (entrada seletiva).',
    8:'Rover + Babysits + Yoopies — combinar pet sitting e babysitting maximiza as horas.',
    10:'Superprof + Preply (tutoria/idiomas) ou TaskRabbit + Merytu (biscates locais).',
    18:'UserInterviews + Respondent.io + TestingTime — sessões de UX bem pagas, disponibilidade limitada em PT.'
  };
  const sEN={
    2:'AttaPoll + YouGov + OnePulse. Add Freecash or ySense (Get-Paid-To) for extra earnings.',
    6:'Uber Eats (Courier), Glovo or Bolt Food (Courier) — high demand in PT cities.',
    7:'DataAnnotation.tech + Clickworker. For qualified profiles: Outlier (selective entry).',
    8:'Rover + Babysits + Yoopies — combining pet sitting and babysitting maximises hours.',
    10:'Superprof + Preply (tutoring/languages) or TaskRabbit + Merytu (local gigs).',
    18:'UserInterviews + Respondent.io + TestingTime — well-paid UX sessions, limited availability in PT.'
  };
...
const TAB_GROUP_LABELS = {
  pt: {
    ...
    'testing':    '🔬 Testes de Usabilidade e Estudos',
    'micro':      '🤖 Treino de IA e Microtarefas',
    'mystery':    '🕵️ Cliente Mistério e Auditoria',
    'gpt':        '🎁 Get-Paid-To',
    'deliveries': '🚗 Entregas, Estafetas e Condução',
    'skills':     '🧑‍🏫 Ensino, Tutorias e Skills',
    'criativo':   '🎨 Stock, Design e E-commerce',
    'creative':   '📱 Criação de Conteúdo e UGC',
    'gigs_events':'🛠️ Biscates, Eventos e Hotelaria',
    'caregiving': '🫶 Caregiving',
    'f2f':        '🤝 Angariação de Fundos (ONGs)',
    'other':      '💚 Outros e Serviços de Nicho',
  },
  en: {
    '':           'All platforms',
    'surveys':    '📝 Surveys & Market Research',
    'testing':    '🔬 Usability Testing & Studies',
    'micro':      '🤖 AI Training & Micro-tasks',
    'mystery':    '🕵️ Mystery Shopping & Auditing',
    'gpt':        '🎁 Get-Paid-To',
    'deliveries': '🚗 Deliveries & Driving',
    'skills':     '🧑‍🏫 Teaching, Tutoring & Skills',
    'criativo':   '🎨 Stock, Design & E-commerce',
    'creative':   '📱 Content Creation & UGC',
    'gigs_events':'🛠️ Local Gigs & Events',
    'caregiving': '🫶 Caregiving',
    'f2f':        '🤝 Face-to-Face Fundraising',
    'other':      '💚 Other & Niche Services',
  },
};
function setTab(v){
  activeTab=v;
...
function applyLang(){
  ...
  if(monoWaBtnEl) monoWaBtnEl.textContent = _isEn2 ? 'Request access via WhatsApp →' : 'Pedir acesso via WhatsApp →';
