...
const translations = {
  pt: {
    ...
    guideTip: '<strong>★ Top 3 para Portugal em 2026 —</strong> <strong>DataAnnotation.tech</strong> (15–25€/h, treinar IA, sem entrevista) · <strong>Prolific</strong> (6–14€/h, surveys académicos, muito fiável) · <strong>Respondent.io</strong> (50–200€/h, entrevistas em inglês, alta barreira de entrada)',
    // Monetization
  ...
  en: {
    ...
    guideTip: '<strong>★ Top 3 for 2026 —</strong> <strong>DataAnnotation.tech</strong> (€15–25/h, AI training, no interview) · <strong>Prolific</strong> (€6–14/h, academic surveys, very reliable) · <strong>Respondent.io</strong> (€50–200/h, English interviews, high barrier to entry)',
    // Monetization
...
async function validarTokenSupabase(token) {
  ...
  try {
    ...
    const { data, error } = await _SB.rpc('unlock_with_token', { p_token: token.trim() });
    if(error) {
