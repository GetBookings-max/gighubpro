...
function calcEarnings(){
  ...
  const sPT={2:'Prolific + Mobrog + AttaPoll.',6:'Uber Eats ou Bolt Food.',7:'DataAnnotation.tech + Clickworker.',8:'Rover + Zoowish + Babysits.pt.',10:'Guru.com + Bark.com (plataformas de freelance generalista, abertas a PT, sem comissão de entrada — qualquer área de serviços).',18:'TestingTime (plataforma europeia de estudos de utilizador com projetos PT disponíveis — pagamento variável por sessão, seletivo).'};
  const sEN={2:'Prolific + Mobrog + AttaPoll.',6:'Uber Eats or Bolt Food.',7:'DataAnnotation.tech + Clickworker.',8:'Rover + Zoowish + Babysits.',10:'Guru.com + Bark.com (general freelance platforms, open to PT, no entry fee — any service area).',18:'TestingTime (European user research platform with PT projects available — variable pay per session, selective).'};
...
const translations = {
  pt: {
    ...
    sortEasy: '✓ Mais fácil',
    sortName: 'A–Z Nome',
    heroTag: '✅ +75 plataformas verificadas · Atualizado',
    ...
    lockHeadline: '+75 plataformas<br><em>verificadas</em> num só lugar',
    ...
    lockIncluiDesc: '+75 plataformas<br>Acesso de longa duração',
  ...
  en: {
    ...
    sortName: 'A–Z Name',
    heroTag: '✅ +75 verified platforms · Updated',
    ...
    lockHeadline: '+75 verified<br><em>platforms</em> in one place',
    ...
    welcomeBody: 'You have access to <strong style="color:var(--ink)">+75 verified platforms</strong> to earn money online — surveys, freelance, AI, physical gigs and much more.<br><br>Use the filters to find what works for you. Start with those marked as <strong style="color:#8a6820">✦ Good to start with</strong>.',
    ...
    lockIncluiDesc: '+75 platforms<br>Long-term access',
...
function applyLockLang(){
  ...
  setText('lockIncluiDesc', '+75 plataformas · Acesso de longa duração', '+75 platforms · Long-term access');
  // Step labels
...
function _mergeF2F(){
  ...
  const toAdd = _F2F_ENTRIES.filter(e=>!existing.has(norm(e.name)));
...
const _EXTRA_ENTRIES = [
  ...
  {name:'ySense',cat:'surveys',icon:'💡',
   ...
   earn:'Variável por survey',earnN:3,minPay:'Por survey',pt:true,eu:true,
   url:'https://www.ysense.com/pt',easy:5,geo:'🌍 Global',top:false,dimmed:false,beginner:true,
   ratings:{payout:3,beginner:true,realistic:2,trust:4}},
...
(function _bindEvents(){
  ...
  // Started only after successful unlock to avoid unnecessary polling.
