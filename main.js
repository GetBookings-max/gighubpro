  ...
  _sessionTimeoutInterval = setInterval(() => {
    ...
    if(idle > 7200000) {
      ...
      if(!expiredToast) {
        ...
        expiredToast.style.cssText = 'position:fixed;bottom:24px;left:50%;transform:translateX(-50%);background:var(--ink);color:var(--paper);font-family:\'Instrument Sans\',sans-serif;font-size:13px;padding:10px 20px;border-radius:10px;z-index:9800;box-shadow:0 4px 20px rgba(0,0,0,.4);border:1px solid rgba(201,168,76,.3);white-space:nowrap;';
