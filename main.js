  ...
  },
  {
    ...
    subgroups: [
      { labelPt:'🏠 Espaço Físico ou Loja', labelEn:'🏠 Physical space or shop',
        cats:['passive'], filter: p => { const n = p.name.toLowerCase(); return !['revolut affiliate','xtb partnerships','booking affiliate','amazon affiliate','shopify affiliate','trade republic affiliate','temu affiliate','letyshops','beruby'].includes(n); } },
      ...
      { labelPt:'💳 Cashback (Ganha ao Comprar)', labelEn:'💳 Cashback (Earn when you shop)',
        cats:['passive'], filter: p => { const n = p.name.toLowerCase(); return ['letyshops','beruby'].includes(n); } },
