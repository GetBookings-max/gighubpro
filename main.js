...
const _LOCAL_EXTRA_PLATFORMS = [
  ...
  },
  {
    ...
    cat: 'f2f',
    icon: '🌿',
    desc: 'Empresa portuguesa especializada na construção e manutenção de jardins, instalação de sistemas de rega automatizados e execução de decks, terraços, pérgulas, vedações e outras estruturas em espaços verdes.',
    descEn: 'Portuguese company specialising in garden construction and maintenance, automated irrigation systems, and the execution of decks, terraces, pergolas, fencing and other green space structures.',
    earn: 'Salário mensal',
    earnN: 9,
    minPay: 'Mensal',
    pt: true, eu: false,
  ...
  },
  {
    ...
    cat: 'criativo',
    icon: '🔗',
    desc: 'Cria conteúdo (artigos, guias, reviews) sobre destinos e atividades turísticas que gera tráfego para o GetYourGuide. Ganhas comissão sobre cada reserva feita através dos teus links de afiliado.',
    descEn: "Create content (articles, guides, reviews) about destinations and activities that drives traffic to GetYourGuide. Earn commission on every booking made through your affiliate links.",
