...
function renderCatExplorer() {
  ...
  // "See all in list" buttons → switch tab and scroll
  grid.querySelectorAll('.cat-expand-see-all').forEach(btn => {
    btn.addEventListener('click', (e) => {
      e.stopPropagation();
      const tabV = btn.dataset.tabv;
      // Map our local cat IDs to TAB_CAT_FILTERS keys
      const _idToTab = {
      ...
      const v = _idToTab[tabV] !== undefined ? _idToTab[tabV] : '';
      setTab(v);
