...
const _ALLOWED_PLATFORMS = new Set([
  ...
  'netsonda',
  'opiniões de valor','opiniões de valor',
  ...
  'apdes','associação salvador','associação salvador',
  ...
  'aldi campanha verão','aldi campanha verão',
  'midas portugal',
  ...
  'fundação inatel','fundacao inatel','residências montepio','residências montepio',
  ...
  // Adicionados — transportes públicos Lisboa
  'carris',
  'ascendi',
  'metro de lisboa',
  'revolut afiliados',
...
const CAT_EXPLORER_DEFS = [
  {
    ...
    subgroups: [
      {
        labelPt: '🚗 Se tens veículo (Carro, Mota ou Bicicleta)',
        labelEn: '🚗 If you have a vehicle (Car, Moto or Bike)',
        platforms: [
          ...
          { name:'Uber Eats (Courier)',    desc:'Estafeta Uber Eats', url:'https://www.uber.com/pt/pt-br/deliver/', icon:'🍔' },
          { name:'Bolt Food (Courier)',    desc:'Estafeta Bolt Food', url:'https://food.bolt.eu/pt-pt/partner/', icon:'🟡' },
      ...
      {
        labelPt: '🔧 Se queres prestar serviços locais (Biscates)',
        labelEn: '🔧 If you want local service gigs',
        platforms: [
      ...
      {
        labelPt: '💻 Se queres trabalhar a partir de casa (Online)',
        labelEn: '💻 If you want to work from home (Online)',
        platforms: [
      ...
      {
        labelPt: '🎭 Se queres trabalhar em Eventos & Audiovisual',
        labelEn: '🎭 If you want Events & Audiovisual work',
        platforms: [
          { name:'Quickcasting',   desc:'Trabalho de figurante e casting', url:'https://www.quickcasting.pt/', icon:'🎬' },
          { name:'Kria Eventos',   desc:'Staff de eventos e produção', url:'https://www.kriaaction.com', icon:'🎪' },
          { name:'Aporfest',       desc:'Voluntariado e staff em festivais', url:'https://aporfest.pt', icon:'🎵' },
          { name:'Spring Events',  desc:'Produção de eventos e espetáculos', url:'https://www.springentertainment.pt', icon:'🎤' },
          { name:'Cloe Events',    desc:'Staff de eventos e hotelaria', url:'https://www.cloe.pt', icon:'🌟' },
        ]
      },
    ]
  },
  {
    ...
    subgroups: [
      {
        labelPt: '🏠 Se tens um Espaço Físico ou Loja',
        labelEn: '🏠 If you have a physical space or shop',
        platforms: [
      ...
      {
        labelPt: '🧪 Se queres participar em Estudos Científicos & Médicos',
        labelEn: '🧪 If you want to join scientific & medical studies',
        platforms: [
          { name:'BlueClinical',      desc:'Ensaios clínicos pagos em Portugal', url:'https://www.blueclinical.pt', icon:'🔬' },
          { name:'iVidador',          desc:'Doação de sémen — compensação financeira', url:'https://www.ivi.pt/tratamentos/banco-esperma/', icon:'🧬' },
          { name:'iVidoa',            desc:'Doação de óvulos — compensação legal', url:'https://www.ivi.pt/tratamentos/doacao-ovulos/', icon:'🧬' },
          { name:'Ava Clinic',        desc:'Doação de esperma e óvulos — clínica especializada', url:'https://www.avaclinic.pt', icon:'🏥' },
      ...
      {
        labelPt: '🔗 Se tens Tráfego / Redes Sociais (Afiliados)',
        labelEn: '🔗 If you have traffic / social media (Affiliates)',
        platforms: [
  ...
  },
  {
    id: 'microtarefas',
    emoji: '🎯',
    titlePt: '🎯 Quero Dinheiro Extra Rápido',
    titleEn: '🎯 I want quick extra cash',
    descPt: 'Para quem está no sofá ou nos intervalos — inquéritos, missões na rua e micro-tarefas pagas.',
    descEn: 'For couch or break time — surveys, street missions and paid micro-tasks.',
    color: '#7a3e00',
    subgroups: [
      {
        labelPt: '🤳 No Telemóvel / Computador',
        labelEn: '🤳 On your phone / computer',
        platforms: [
      ...
      {
        labelPt: '🕵️ Na Rua (Cliente Mistério & Auditorias)',
        labelEn: '🕵️ On the street (Mystery Shopping & Audits)',
        platforms: [
  ...
  },
  {
    ...
    subgroups: [
      {
        labelPt: '📞 Escritório, Call Center & Apoio Remoto',
        labelEn: '📞 Office, Call Center & Remote Support',
        platforms: [
          { name:'Teleperformance',  desc:'Atendimento ao cliente e suporte técnico', url:'https://www.teleperformance.com/pt-pt/locations/portugal/recrutamento/', icon:'🎧' },
          { name:'Concentrix',       desc:'Call center e suporte ao cliente', url:'https://jobs.concentrix.com', icon:'📞' },
          { name:'Foundever',        desc:'Customer support e BPO', url:'https://foundever.com/pt/careers/', icon:'💬' },
          { name:'Fujitsu Careers',  desc:'IT, digital e serviços empresariais', url:'https://fujitsu.com/pt/about/local/corporate/careers/', icon:'💻' },
          { name:'Accenture',        desc:'Consulting, tech e operações', url:'https://www.accenture.com/pt-pt/careers', icon:'🏛️' },
          { name:'Indiecampers',     desc:'Apoio ao cliente e operações de campervans', url:'https://www.indiecampers.com/careers', icon:'🚐' },
          { name:'ComparaJá',        desc:'Comparação de seguros e crédito — suporte', url:'https://www.comparaja.pt/emprego', icon:'🔎' },
          { name:'Consultor Kobold', desc:'Vendas e consultoria por telefone', url:'https://www.kobold.com/pt/empresa/empregos/', icon:'🏠' },
        ]
      },
      {
        labelPt: '🏪 Lojas, Retalho & Logística Comercial',
        labelEn: '🏪 Stores, Retail & Commercial Logistics',
        platforms: [
          { name:'IKEA',               desc:'Retalho, armazém e montagem', url:'https://www.ikea.com/pt/pt/jobs/', icon:'🛋️' },
          { name:'Leroy Merlin',       desc:'Vendedor e especialista de bricolage', url:'https://carrieres.leroymerlin.pt', icon:'🔨' },
          { name:'Sonae',              desc:'Continente, SPORT ZONE e outras insígnias', url:'https://emprego.sonae.com', icon:'🛒' },
          { name:'Grupo Ibersol',      desc:'Restauração — Pizza Hut, KFC, Pasta Caffé', url:'https://www.grupoibersol.pt/carreiras/', icon:'🍔' },
          { name:'Grupo Nabeiro',      desc:'Delta Cafés e restauração', url:'https://www.gruponabeiro.com/carreiras/', icon:'☕' },
          { name:'Repsol',             desc:'Estações de serviço e loja', url:'https://www.repsol.pt/pt/emprego/', icon:'⛽' },
          { name:'Norauto',            desc:'Assistência e serviços automóvel', url:'https://www.norauto.pt/recrutamento/', icon:'🚗' },
          { name:'Portugal Duty Free (PTDF)', desc:'Loja nos aeroportos portugueses', url:'https://www.ptdf.pt/recrutamento', icon:'✈️' },
          { name:'Salesland',          desc:'Promotor e vendedor presencial', url:'https://www.salesland.net/pt/emprego', icon:'🤝' },
          { name:'Midas',              desc:'Mecânico e técnico auto', url:'https://www.midas.pt/sobre-nos/trabalha-connosco', icon:'🔧' },
          { name:'Makro',              desc:'Armazém e atendimento a profissionais', url:'https://www.makro.pt/recrutamento', icon:'🏭' },
        ]
      },
      {
        labelPt: '🚚 Transportes, Indústria & Infraestruturas',
        labelEn: '🚚 Transport, Industry & Infrastructure',
        platforms: [
          { name:'Carris',                    desc:'Motorista e operacional de transportes municipais Lisboa', url:'https://careers.carris.pt/search/?createNewAlert=false&q=', icon:'🚌' },
          { name:'Metro de Lisboa',            desc:'Assistente de estação, técnico e operações do Metro', url:'https://www.metrolisboa.pt/institucional/junte-se-nos/recrutamentos/', icon:'🚇' },
          { name:'Ascendi',                    desc:'Operador de portagem e manutenção de autoestradas', url:'https://ascendi.csod.com/ux/ats/careersite/4/home?c=ascendi', icon:'🛣️' },
          { name:'Brisa',                    desc:'Portagens, manutenção e operações', url:'https://www.brisa.pt/pt/trabalha-connosco', icon:'🛣️' },
          { name:'Ryanair',                  desc:'Tripulante de cabine e operações aeroportuárias', url:'https://careers.ryanair.com', icon:'✈️' },
          { name:'Portway',                  desc:'Handling e assistência em aeroportos PT', url:'https://www.portway.pt/pt/carreiras/', icon:'🛫' },
          { name:'DHL',                      desc:'Motorista, armazém e logística', url:'https://careers.dhl.com', icon:'📦' },
          { name:'Torrestir',                desc:'Transportes e logística nacional', url:'https://www.torrestir.pt/emprego', icon:'🚛' },
          { name:'Mota-Engil',               desc:'Construção civil e engenharia', url:'https://www.mota-engil.pt/carreiras/', icon:'🏗️' },
          { name:'Infraestruturas de Portugal', desc:'Manutenção de estradas e caminhos de ferro', url:'https://www.infraestruturasdeportugal.pt/recrutamento/', icon:'🚧' },
          { name:'Transdev',                 desc:'Motorista de autocarro e metro ligeiro', url:'https://www.transdev.pt/emprego/', icon:'🚌' },
          { name:'Barraqueiro',              desc:'Motorista e operações de transporte público', url:'https://www.barraqueiro.pt/recrutamento', icon:'🚍' },
        ]
      },
      {
        labelPt: '🎪 Sazonal, Turismo & Parques (Contratos de Verão)',
        labelEn: '🎪 Seasonal, Tourism & Parks (Summer contracts)',
        platforms: [
          { name:'Aldi Campanha Verão',  desc:'Contrato sazonal de verão na Aldi', url:'https://www.aldi.pt/recrutamento/', icon:'🛒' },
          { name:'Campanha Tomate',      desc:'Colheita sazonal no Ribatejo — alojamento incluído', url:'https://www.campanhadotomate.pt', icon:'🍅' },
          { name:'Douro Azul',           desc:'Staff de cruzeiros fluviais e hotelaria', url:'https://www.douroazul.com/emprego/', icon:'⛵' },
          { name:'Lisbon Boats',         desc:'Staff de passeios de barco em Lisboa', url:'https://www.lisbonboats.com', icon:'🚢' },
          { name:'Lisbon Pub Crawl',     desc:'Guia/staff de pub crawl — base + comissões', url:'https://www.lisbonpubcrawl.com/work-with-us/', icon:'🎉' },
          { name:'City Sightseeing',     desc:'Staff de autocarros turísticos hop-on hop-off', url:'https://www.city-sightseeing.com/franchise/become-a-franchisee.htm', icon:'🚌' },
          { name:'GuruWalk',             desc:'Free walking tour guides', url:'https://www.guruwalk.com/become-a-guide', icon:'🗺️' },
          { name:'New Europe Tours',     desc:'Guia de free walking tours em Lisboa e Porto', url:'https://www.neweuropetours.eu/guide-with-us/', icon:'🎒' },
          { name:'GetYourGuide',         desc:'Operador de experiências e tours locais', url:'https://supply.getyourguide.com', icon:'🌍' },
          { name:'Casamentos.pt',        desc:'Fotógrafo, DJ, catering e outros prestadores', url:'https://www.casamentos.pt/registo-profissional/', icon:'💍' },
          { name:'Worldpackers',         desc:'Voluntariado em troca de alojamento — viagens', url:'https://www.worldpackers.com', icon:'🌿' },
          { name:'Badoca Safari Park',   desc:'Staff de parque de animais selvagens', url:'https://www.badoca.com/emprego', icon:'🦒' },
          { name:'Zoomarine',            desc:'Staff de parque aquático e aquário', url:'https://www.zoomarine.pt/emprego', icon:'🐬' },
          { name:'Aqualand',             desc:'Staff de parque aquático — verão', url:'https://www.aqualand.pt/emprego', icon:'🏊' },
          { name:'Aquashow',             desc:'Staff de parque aquático Aquashow', url:'https://www.aquashow.pt/emprego', icon:'🌊' },
          { name:'Sirius Park',          desc:'Staff de parque temático', url:'https://www.siriuspark.pt', icon:'🎠' },
          { name:'Orbitur',              desc:'Animadores e staff de campismo', url:'https://www.orbitur.pt/recrutamento/', icon:'⛺' },
          { name:'INATEL',              desc:'Animadores, monitores e staff de turismo social', url:'https://www.inatel.pt/recrutamento/', icon:'🏕️' },
          { name:'Ritmos Fortes',        desc:'Staff de eventos musicais e festivais', url:'https://www.ritmosfortes.pt', icon:'🎶' },
          { name:'SalvaMais',            desc:'Nadadores-salvadores — praias e piscinas PT', url:'https://www.salvamais.pt', icon:'🏊' },
          { name:'Guia Tuk Tuk',         desc:'Condutor e guia turístico em tuk-tuk', url:'https://www.tuktuk.pt/emprego', icon:'🛺' },
          { name:'Monitores Oeiras',     desc:'Monitor de atividades de verão — Oeiras', url:'https://www.oeiras.pt/emprego', icon:'🏅' },
        ]
      },
      {
        labelPt: '🧹 Limpeza, Segurança & Suporte Operacional',
        labelEn: '🧹 Cleaning, Security & Operational Support',
        platforms: [
          { name:'Prosegur',            desc:'Segurança, transporte de valores e vigilância', url:'https://www.prosegur.pt/emprego/', icon:'🛡️' },
          { name:'Securitas',           desc:'Segurança em superfícies comerciais e eventos', url:'https://www.securitas.pt/carreiras/', icon:'🔒' },
          { name:'Trablisa ESEgur',     desc:'Segurança e proteção de pessoas e bens', url:'https://www.esegur.com/emprego/', icon:'🔐' },
          { name:'Servilusa',           desc:'Serviços funerários — suporte e logística', url:'https://www.servilusa.pt/recrutamento/', icon:'🕊️' },
          { name:'RGIS',                desc:'Inventário e contagem em armazéns e lojas', url:'https://www.rgis.com/pt-pt/emprego/', icon:'📦' },
          { name:'Ecoambiente',         desc:'Recolha de resíduos e serviços ambientais', url:'https://www.ecoambiente.pt/recrutamento', icon:'♻️' },
          { name:'Prezero',             desc:'Gestão de resíduos e economia circular', url:'https://jobs.prezero.com/Portugal/?locale=pt_PT', icon:'🌿' },
          { name:'Parques de Sintra',   desc:'Guarda e operacional em jardins históricos', url:'https://www.parquesdesintra.pt/sobre-nos/trabalha-connosco/', icon:'🌳' },
          { name:'Luz Saúde',           desc:'Limpeza, receção e suporte em clínicas', url:'https://www.luzsaude.pt/pt/trabalha-connosco/', icon:'🏥' },
          { name:'Lusíadas Saúde',      desc:'Limpeza, receção e suporte hospitalar', url:'https://www.lusiadas.pt/pt/recrutamento/', icon:'🏨' },
          { name:'Residências Montepio', desc:'Auxiliar e staff em lares de idosos', url:'https://www.residenciasmontepiogroup.pt/recrutamento', icon:'🏡' },
          { name:'Blue & Green Hotels', desc:'Hotelaria, limpeza e receção', url:'https://www.blueandgreenhotels.com/careers/', icon:'🌊' },
        ]
      },
      {
        labelPt: '🤝 Angariação Face-to-Face (Causas / Rua)',
        labelEn: '🤝 Face-to-Face Fundraising (Causes / Street)',
        platforms: [
...
// ── Legacy flat-platforms compat: flatten subgroups into .platforms for filter matching
CAT_EXPLORER_DEFS.forEach(cat => {
  if(cat.subgroups && !cat.platforms) {
    cat.platforms = cat.subgroups.reduce((acc, sg) => acc.concat(sg.platforms), []);
  }
});

// (retired flat-format categories removed — now in new 4-intention structure)
...
function renderCatExplorer() {
  ...
  // ── Platform item renderer — defined once outside map for performance
  ...
  const html = CAT_EXPLORER_DEFS.map(cat => {
    ...
    // ── Render platforms — with subgroup labels if cat has subgroups
    let platformsHtml = '';
    if(cat.subgroups) {
      let globalIdx = 0;
      platformsHtml = cat.subgroups.map(sg => {
        const sgLabel = isEn ? sg.labelEn : sg.labelPt;
        const sgFiltered = sg.platforms.filter(_platformPasses);
        if(sgFiltered.length === 0) return '';
        const itemsHtml = sgFiltered.map(p => _renderPlatformItem(p, globalIdx++)).join('');
        return `
      ...
      platformsHtml = filteredPlatforms.map(_renderPlatformItem).join('');
    }
...
(function _hookCatExplorer() {
  ...
  window.render = function() {
    ...
    if(hasAccess && document.getElementById('catGrid')) {
      ...
      _catExplorerTimer = setTimeout(() => renderCatExplorer(), 50);
    }
  };
})();
