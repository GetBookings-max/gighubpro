...
const _REDUCED_EXPECTATIONS = {
  ...
  'iVidador': {
    desc: 'Programa de doação de esperma da Clínica IVI Lisboa. Processo confidencial, com triagem médica prévia. A compensação é estipulada por lei e é bastante reduzida — indicado para quem quer ajudar outros a constituir família, mais do que como fonte de rendimento.',
