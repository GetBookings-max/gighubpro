...
const translations = {
  pt: {
    ...
    lockIncluiDesc: '+90 plataformas<br>Acesso de longa duração',
  ...
  en: {
    ...
    welcomeBody: 'You have access to <strong style="color:var(--ink)">+90 verified platforms</strong> to earn money online — surveys, freelance, AI, physical gigs and much more.<br><br>Use the filters to find what works for you. Start with those marked as <strong style="color:#8a6820">✦ Good to start with</strong>.',
    ...
    lockIncluiDesc: '+90 platforms<br>Long-term access',
...
function applyLockLang(){
  ...
  setText('lockIncluiDesc', '+90 plataformas · Acesso de longa duração', '+90 platforms · Long-term access');
  // Step labels
