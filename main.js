...
const _BLOCKED = new Set([
  ...
  // ── Removidas por pedido ──
  'BuyMeACoffee','Teachable','IPSOS iSay','Branded Surveys',
  'Neevo','Zintellect','EarnApp','CloudWorkers',
  // ── Dedup: Sua Opinião Conta vem de _EXTRA_ENTRIES ──
  'Sua Opinião Conta'
]);
...
// ── Top 3 forced overrides ────────────────────────────────────────
// These are always shown as TOP PICK regardless of Supabase data
const _TOP_FORCED = new Set(['AttaPoll','Clickworker','OnePulse']);
...
function _fmt(r){
  ...
  return {
    ...
    top: isDimmed ? false : (_TOP_FORCED.has(r.name) || r.top || false),
    dimmed: isDimmed,
