...
//
// TIER 1 🟢 Rendimento Consistente  — trabalho estável, paga contas
// TIER 2 🟡 Variável mas Real       — depende de skill / disponibilidade
// TIER 3 🔴 Complementar            — baixa consistência, tempos mortos
// TIER 4 🟣 Canal de Descoberta     — ferramentas para encontrar trabalho
//
...
const _TIER3_NAMES = new Set([
  ...
  'SproutGigs','Storewards','SuaOpiniãoConta','TGM Panel',
  'Toloka AI','Triaba','Voz do Consumidor','YouGov',
  'Hotjar Engage','PlaytestCloud','We Are Testers',
  'Beruby',
]);
...
function _tierBadge(p){
  ...
  const isEn = currentLang === 'en';
  const map = isEn
    ? {1:'🟢 Consistent Income — can pay bills', 2:'🟡 Variable but Real — skill & availability', 3:'🔴 Lottery / Low Consistency', 4:'🟣 Discovery Channel'}
    : {1:'🟢 Rendimento Consistente — pode pagar contas', 2:'🟡 Variável mas Real — depende de skill e disponibilidade', 3:'🔴 Lotaria / Baixa Consistência', 4:'🟣 Canal de Descoberta'};
  return `<span class="tier-badge tier-${tier}">${map[tier]}</span>`;
}
...
const translations = {
  pt: {
    ...
    tierLeg1: '🟢 Rendimento Consistente — pode pagar contas',
    tierLeg2: '🟡 Variável mas Real — depende de skill e disponibilidade',
    tierLeg3: '🔴 Lotaria / Baixa Consistência',
    tierLeg4: '🟣 Canal de Descoberta',
  ...
  en: {
    ...
    tierLeg1: '🟢 Consistent Income — can pay bills',
    tierLeg2: '🟡 Variable but Real — skill & availability',
    tierLeg3: '🔴 Lottery / Low Consistency',
    tierLeg4: '🟣 Discovery Channel',
