...
const translations = {
  pt: {
    ...
    guideTip: '<strong>★ Top 3 para Portugal em 2026 —</strong> <strong>Teleperformance</strong> (atendimento ao cliente, estável, entrada relativamente fácil, boa remuneração) · <strong>Lisbon Pub Crawl</strong> (guia/staff noturno em Lisboa, entrada fácil) · <strong>Amnistia Internacional</strong> (angariação de fundos paga, entrada fácil, ótima para começar)',
