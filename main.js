...
const _DESC_SUFFIX = {
  'Attapoll': ' ☕ Pagam pouco, mas servem para o café.',
  'Multidados': ' ☕ Pagam pouco, mas servem para o café.',
  'Marktest': ' ☕ Pagam pouco, mas servem para o café.',
  'Prime Opinion': ' ☕ Pagam pouco, mas servem para o café.',
  'Voz do Consumidor': ' ☕ Pagam pouco, mas servem para o café.',
  'Netsonda': ' ☕ Pagam pouco, mas servem para o café.',
  'Boutique Opiniões': ' ☕ Pagam pouco, mas servem para o café.',
  'SuaOpiniãoConta': ' ☕ Pagam pouco, mas servem para o café.',
  'Opiniões de Valor': ' ☕ Pagam pouco, mas servem para o café.',
  'Freecash': ' ☕ Pagam pouco, mas servem para o café.',
  'Roamler': ' ☕ Pagam pouco, mas servem para o café.',
};
...
const _LOCAL_EXTRA_PLATFORMS = [
  {
    ...
    cat: 'passive',
    icon: '📦',
    desc: 'A maior rede de pontos de recolha em Portugal. Ideal para lojas em zonas urbanas ou com tráfego pedonal elevado — o volume de encomendas DHL garante clientes regulares sem esforço de marketing.',
    descEn: "The largest parcel pickup network in Portugal. Best suited for shops in urban areas or high foot-traffic locations — DHL's parcel volume brings regular customers with no marketing effort needed.",
  ...
  },
  {
    ...
    cat: 'passive',
    icon: '🟤',
    desc: 'Opção forte para negócios com clientela internacional ou próximos de zonas industriais e escritórios. A UPS tem quota elevada em envios B2B e cross-border — diferente do perfil mais doméstico da DHL.',
    descEn: "Strong option for businesses with international customers or near industrial zones and offices. UPS holds a large share of B2B and cross-border shipments — a different profile from DHL's more domestic focus.",
    earn: 'Comissão por encomenda',
    earnN: 6,
    minPay: 'Por entrega',
    pt: true, eu: true,
  ...
  },
  {
    ...
    cat: 'passive',
    icon: '🔴',
    desc: 'A escolha mais acessível para pequenos negócios e lojas de bairro. A DPD está em forte crescimento em Portugal impulsionada pelo e-commerce nacional — boa opção se a DHL ou UPS já têm ponto próximo na tua rua.',
    descEn: "The most accessible option for small businesses and neighbourhood shops. DPD is growing fast in Portugal driven by domestic e-commerce — a good choice if DHL or UPS already have a nearby point on your street.",
    earn: 'Comissão por encomenda',
    earnN: 6,
    minPay: 'Por entrega',
    pt: true, eu: true,
...
const _ALLOWED_PLATFORMS = new Set([
  ...
  'monitores oeiras','fw-monitoresjm','monitores jm oeiras',
