    ...
    subgroups: [
      ...
      },
      {
        ...
        platforms: [
          ...
          { name:'Castings',       desc:'Plataforma de castings para figurantes, modelos e atores', url:'https://www.castings.pt', icon:'🎭' },
    ...
    subgroups: [
      {
        ...
        platforms: [
          ...
          { name:'Pitagórica',       desc:'Contact center e BPO — atendimento ao cliente e suporte técnico', url:'https://www.pitagorica.pt/emprego', icon:'📞' },
        ]
      },
      {
      ...
      },
      {
        ...
        platforms: [
          ...
          { name:'Campanha do Tomate Portugal', desc:'Trabalho agrícola sazonal no Ribatejo — colheita e linha de produção. Contrato e alojamento frequentemente incluídos.', url:'https://www.campanhadotomate.pt', icon:'🍅' },
