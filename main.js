...
const _REDUCED_EXPECTATIONS = {
  ...
  'dscout': {
    ...
    descEn: 'Quanto mais extensa a tarefa, maior o pagamento (média de 1$ por minuto).'
  },
  '99designs': {
  ...
  'Hotjar Engage': {
    desc: 'Get paid to share your opinion. Earn €30 on average for each interview.',
  ...
  'Yoopies': {
    ...
    descEn: 'Cuidados infantis Cuidados domiciliários Limpeza Explicadores Petsitter'
  },
  // ── Remote Jobs ───────────────────────────────────────────────────────────
  'HomeFromCollege': {
    desc: 'product testing, surveys and ambassador programs; you do not need to be a college student or have gone to college to apply to GIGs.',
  ...
  'ACNUR': {
    ...
    descEn: 'Projetos Face to Face e Door to Door em Lisboa, Porto e Braga; Valor base desde 5€ por hora + incentivos de desempenho'
  },
  'Aldeias SOS': {
    ...
    descEn: 'Projetos Face to Face e Door to Door em Lisboa, Porto e Braga; entrada imediata; remuneração composta por valor fixo + bónus por cada Amigo SOS angariado. Os recrutadores F2F ganham em média 500€/ 600€ por mês, em regime de prestação de serviços / recibos verdes.'
  },
  'Amnistia Internacional': {
    desc: 'Projeto F2F e D2D; Part-time 500-700€/mês; subsídio de alimentação, subsídio de transportes, progressão de carreira',
    descEn: 'Projeto F2F e D2D; Part-time 500-700€/mês; subsídio de alimentação, subsídio de transportes, progressão de carreira'
  },
  'APDES': {
    desc: 'F2F no Porto, part-time salário base acrescido de componente variável',
    descEn: 'F2F no Porto, part-time salário base acrescido de componente variável'
  },
  // ── Get-Paid-To ───────────────────────────────────────────────────────────
  'Lootup': {
    desc: 'Share your opinion, play games, complete offers, watch videos, shop & earn cash back, enter giveaways, and more. Redeem your rewards as you earn, for cash via PayPal, gift cards, or cryptocurrency via BitPay.',
  ...
  'Earnlab': {
    desc: 'traditional task-based earning and interactive games. Users can earn Coins by completing surveys, downloading apps, and engaging with partner offers.',
  ...
  'Freecash': {
    ...
    descEn: 'testa aplicativos e jogos; a maioria leva cerca de 5-10 minutos para completar; cada tarefa = 1000 moedas = $1.'
  },
  // ── Gigs ──────────────────────────────────────────────────────────────────
  'Eloquence Events': {
    desc: 'work as a brand ambassador, promoter, waiter, assembler, festival assistant, instructor, actor, musician, dancer, etc',
  ...
  'Guia Tuk Tuk': {
    ...
    descEn: 'Necessário mais de 2 anos de experiência com uma carteira de motorista válida e em vigor, inglês avançado (nível mínimo B2) e domínio bilíngue de português (para posições em Lisboa).'
  },
  // ── Nicho / Doação ────────────────────────────────────────────────────────
  'iVidador': {
    desc: 'Programa de doação de espermatozoides em Portugal. Remuneração por doação em clínicas certificadas.',
    descEn: 'Programa de doação de espermatozoides em Portugal. Remuneração por doação em clínicas certificadas.'
  },
  'iVidoa': {
    desc: 'Programa de doação de óvulos em Portugal. Remuneração por doação em clínicas certificadas.',
    descEn: 'Programa de doação de óvulos em Portugal. Remuneração por doação em clínicas certificadas.'
  },
  // ── User-specified description overrides ─────────────────────────────────
  'Ordo Events': {
    desc: 'inscreve-te como DJ e arranja gigs',
    descEn: 'inscreve-te como DJ e arranja gigs'
  },
  'Acclaro': {
    desc: 'Sign up, pass language skills test, start translating.',
...
async function validarTokenSupabase(token, fromUrl) {
  ...
  try {
    ...
    if(data.platforms && data.platforms.length > 0) {
      ...
      // Deduplicate by name (case-insensitive, whitespace-normalised) — keeps first occurrence
      const _seen = new Set();
      P = P.filter(p => {
        const k = p.name.toLowerCase().trim().replace(/\s+/g,' ');
