...
function applyLang(){
  ...
  setInner2('canaisVanguardistaDesc','Empresa portuguesa de comunicação e lifestyle — vagas em marketing, editorial, eventos e produção criativa.',
                                     'Portuguese communication and lifestyle company — vacancies in marketing, editorial, events and creative production.');
  setInner2('canaisBadocaDesc',      'Vagas sazonais e permanentes no Badoca Safari Park — animação, atendimento ao público, manutenção e cuidado de animais.',
                                     'Seasonal and permanent vacancies at Badoca Safari Park — entertainment, visitor services, maintenance and animal care.');
  setInner2('canaisAporfestDesc',    'Associação portuguesa de festivais de artes — emprego e oportunidades em festivais de música, teatro e cultura por todo o país.',
                                     'Portuguese association of arts festivals — jobs and opportunities at music, theatre and cultural festivals across the country.');
  setInner2('canaisKriaDesc',        'Agência de eventos com recrutamento regular de promotores e staff para eventos, feiras e ativações de marca em Portugal.',
                                     'Events agency with regular recruitment of promoters and staff for events, fairs and brand activations in Portugal.');
  setInner2('canaisSpringEventsDesc','Empresa de eventos com vagas para staff, produção e logística em festivais e eventos culturais por Portugal.',
                                     'Events company with vacancies for staff, production and logistics at festivals and cultural events across Portugal.');
  setInner2('canaisCloeEventsDesc',  'Empresa de organização de eventos com candidaturas para staff, promotores e produção de eventos em Portugal.',
                                     'Event management company with applications for staff, promoters and event production in Portugal.');
  setInner2('canaisNorautoDesc',     'Portal de emprego do Norauto — rede de autocentros com vagas em mecânica, atendimento, vendas e gestão de loja em todo o país.',
                                     'Norauto jobs portal — automotive service chain with vacancies in mechanics, customer service, sales and store management nationwide.');
